var canvasfaceplate = document.getElementById("drawing_area");
var bsp_context = canvasfaceplate.getContext('2d');
var hsp_context = canvasfaceplate.getContext('2d');
var flu_context = canvasfaceplate.getContext('2d');
var flo_context = canvasfaceplate.getContext('2d');
var hsp_measure = canvasfaceplate.getContext('2d');
var LeftWeb_context = canvasfaceplate.getContext('2d');
var RightWeb_context = canvasfaceplate.getContext('2d');
var Left_Low_sec_context = canvasfaceplate.getContext('2d');
var Right_Low_sec_context = canvasfaceplate.getContext('2d');
var Left_Up_sec_context = canvasfaceplate.getContext('2d');
var Right_Up_sec_context = canvasfaceplate.getContext('2d');
var Low_screw_left_context = canvasfaceplate.getContext('2d');
var Low_screw_right_context = canvasfaceplate.getContext('2d');;
var mid_screw_right_context = canvasfaceplate.getContext('2d');
var mid_screw_left_context = canvasfaceplate.getContext('2d');
var up_screw_left_context = canvasfaceplate.getContext('2d');
var up_screw_right_context = canvasfaceplate.getContext('2d');
...
function draw_screws() {
    ...
    var h2_measure = canvasfaceplate.getContext('2d');
    ...
    var bsp_number = canvasfaceplate.getContext('2d');
    bsp_number.font = '7px Arial';
    bsp_number.fillStyle = 'black';
    bsp_number.fillText(bsp.toFixed(2), 55 + 125 * bsp / hsp, 8);
    ...
    var hsp_number = canvasfaceplate.getContext('2d');
    hsp_number.font = '7px Arial';
    hsp_number.fillStyle = 'black';
    hsp_number.fillText(hsp.toFixed(2), 25, 149 - 0.5 * hsp * y_factor)

    if (u1n !== 0) {
        var u1nleft_number = canvasfaceplate.getContext('2d');
        u1nleft_number.font = '7px Arial';
        u1nleft_number.fillStyle = 'black';
        u1nleft_number.fillText(u1n.toFixed(2), 3, 149 - 0.5 * u1n * y_factor);
    }

    var h_number = canvasfaceplate.getContext('2d');
    h_number.font = '7px Arial';
    h_number.fillStyle = 'black';
    h_number.fillText(h.toFixed(2), 1, 149 - (u1n + 0.5 * h) * y_factor);
    ...
    var bsp_m_sum = canvasfaceplate.getContext('2d');
    bsp_m_sum.beginPath();
    ...
    var profile = canvasfaceplate.getContext('2d');
    profile.font = '9px Arial';
    profile.fillStyle = 'black';
    profile.fillText(selectedProfile, 10, 10);

    var screwtype = canvasfaceplate.getContext('2d');
    profile.font = '9px Arial';
    profile.fillStyle = 'black';
